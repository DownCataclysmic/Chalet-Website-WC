...
const about = () => {
  return (
    <div className="items-center">
      ...
      <p className="text-xl text-gray-600 px-10 py-4">
      ...
      <div>
        <img
          src="https://scontent-lhr8-1.xx.fbcdn.net/v/t39.30808-6/360091296_7161268230553993_492239048233066245_n.jpg?_nc_cat=107&cb=99be929b-59f725be&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=tXNzeW_K-mcAX-IJmQb&_nc_ht=scontent-lhr8-1.xx&oh=00_AfB6mX-E0DAlUD-kMsjy7ITLZ6ik-p7LoJj_Tww7zwc6Ww&oe=64BD1006"
          alt="About Us"
          className="w-full rounded-lg shadow-lg px-4"
        />
      </div>
    </div>
  );
